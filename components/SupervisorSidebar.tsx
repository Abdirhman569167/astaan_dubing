...
export default function SupervisorSidebar({ open = true }: SupervisorSidebarProps) {
  ...
  const systemMenuItems = [
    { path: "/Supervisor/Reports-Analytics", icon: BarChart, label: "Reports & Analytics" },
    { path: "/Supervisor/Notifications", icon: Bell, label: "Notifications" },
    { path: "/Supervisor/Payroll-Commissions", icon: DollarSign, label: "Payments" },

...
export default function Voice0verArtistSidebar() {
  ...
  const mainMenuItems = [
    { path: "/Voice-over-Artist", icon: Home, label: "Dashboard" },
    { path: "/Voice-over-Artist/My-Tasks", icon: ListChecks, label: "My Tasks" },  
  ];

  const toolsMenuItems = [
    { path: "/Voice-over-Artist/Chats", icon: MessageCircle, label: "Chats" },  

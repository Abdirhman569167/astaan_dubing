              ...
              {isNotificationOpen && (
                <div className="absolute right-0 mt-2 w-80 max-h-[70vh] overflow-auto bg-white rounded-xl shadow-lg border border-gray-100 z-50">
                  <div className="p-3 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <Link href="/Editor/Notifications" className="text-sm text-[#ff4e00] hover:underline">
                      View All
                    </Link>
                  </div>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  <p className="text-sm font-medium text-gray-700">{user?.name || "Editor"}</p>
                  <p className="text-xs text-gray-500">{user?.role || "Editor"}</p>
                </div>
